    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="dashboard.html"><img src="assets/img/logo.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="dashboard.html"><img src="assets/img/logo-mini.svg" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="assets/img/face28.png" alt="image">
                </div>
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div class="p-3 text-center bg-info">
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="assets/img/face28.png" alt="">
                </div>
                <div class="p-2">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/img/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/img/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/img/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
      ...
      <div class="container-fluid page-body-wrapper">
        <!-- partial:../../partials/_sidebar.html -->
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="sidebar-collapsed.html">
                <span class="icon-bg"><i class="mdi mdi-widgets menu-icon"></i></span>
                <span class="menu-title">Icon sidebar</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="icons">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="simple-icon.html">Simple line icons</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="datatables.html">Data table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="jsgrid.html">Js-grid</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="faq2.html"> FAQ 2 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="news.html"> News grid </a></li>
                  <li class="nav-item"> <a class="nav-link" href="timeline.html"> Timeline </a></li>
                  <li class="nav-item"> <a class="nav-link" href="userlist.html"> User listing </a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="e-commerce">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="email-template.html"> Email template </a></li>
                  <li class="nav-item"> <a class="nav-link" href="product.html"> Product catalogue </a></li>
                  <li class="nav-item"> <a class="nav-link" href="project.html"> project list </a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-muted font-weight-bold mb-2"> Overview dashboard </h2>
              <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                <div class="btn-group bg-dark-grey p-3" role="group" aria-label="Basic example">
                  <button type="button" class="btn btn-link grey-color py-0 border-right">7 Days</button>
                  <button type="button" class="btn btn-link grey-color py-0 border-right">1 Month</button>
                  <button type="button" class="btn btn-link grey-color py-0">3 Month</button>
                </div>
                <div class="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
                  <button class="btn bg-dark-grey dropdown-toggle p-3 d-flex align-items-center grey-color" type="button" id="dropdownMenuButton1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-calendar mr-1"></i>24 Mar 2019 - 24 Mar 2019 </button>
